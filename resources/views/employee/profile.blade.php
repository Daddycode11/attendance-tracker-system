...
<div class="page-header">
    <div>
        <h1>My Profile</h1>
        <p>View your information and change your password.</p>
    </div>
</div>
        ...
        <div class="card-body">
            ...
            <div style="display:flex; align-items:center; gap:16px; margin-bottom:22px;">
                ...
                <div>
                    ...
                    <span class="badge badge-present" style="margin-top:6px; display:inline-block;">
                        {{ auth()->user()->role }}
                    </span>
                </div>
            </div>
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:14px; font-size:.85rem;">
                ...
                <div>
                    <div style="color:var(--muted); font-size:.72rem; font-weight:700; text-transform:uppercase; letter-spacing:.07em; margin-bottom:3px;">Email</div>
                    <div style="font-weight:600;">{{ auth()->user()->employee->email ?? '—' }}</div>
                </div>
                <div>
                    <div style="color:var(--muted); font-size:.72rem; font-weight:700; text-transform:uppercase; letter-spacing:.07em; margin-bottom:3px;">Contact</div>
                    <div style="font-weight:600;">{{ auth()->user()->employee->contact_number ?? '—' }}</div>
                </div>
                <div>
